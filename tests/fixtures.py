"""Fake backend fixtures for deterministic testing without hardware."""

from robocode.utils.models import RobotStatus, BackendHealth


class FakeRobotBackend:
    """Fake backend that returns configurable responses, no real hardware."""

    def __init__(self):
        self._motor_angles = [180.0, 90.0, 83.0, 30.0, 110.0, 30.0]
    ...
    def move_xyz_rotation(self, position, orientation, rotation_order="zyx", speed_ratio=1.0):
        ...
        return 0.5  # simulated motion time
