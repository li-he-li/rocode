...
from robocode.cli.tools_setup import register_all_tools, build_handler_map
from robocode.cli import experience_ui as _exp_ui
...
class RobocodeApp:
    # 方法体在 tools_setup.py / experience_ui.py，类属性赋值自动变成 bound method 喵~
    _register_tools = register_all_tools
    _build_handler_map = build_handler_map
    _run_exp_manage = _exp_ui._run_exp_manage
    _apply_confidence_feedback = _exp_ui._apply_confidence_feedback
    _prompt_annotation_after_task = _exp_ui._prompt_annotation_after_task
    _run_annotation_panel = _exp_ui._run_annotation_panel
